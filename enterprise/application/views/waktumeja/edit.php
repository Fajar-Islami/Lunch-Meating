            ...
            <div class="card shadow-sm border-bottom-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input value=" <?= set_value('jam_mulai', date('H:i', $twm['jam_mulai'] - 25200)); ?>" id="jam_mulai" name="jam_mulai" class="form-control jammulai" readonly />
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input value="<?= set_value('jam_selesai', date('H:i', $twm['jam_selesai'] - 25200)); ?>" id="jam_selesai" name="jam_selesai" class="form-control jamselesai" readonly />
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input value="<?= set_value('kode_waktu', $twm['kode_waktu']); ?>" name="kode_waktu" id="kode_waktu" type="text" class="form-control" placeholder=" Masukan kode kode waktu">
