                ...
                <div class="card-body">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <select name="id_waktu_meja" id="id_waktu_meja" class="custom-select">
                                    ...
                                    <?php foreach ($twaktu_meja as $wm) : ?>
                                        <option <?= $tmeja['id_waktu_meja'] == $wm['id_waktu'] ? 'selected' : ''; ?> <?= set_select('id_waktu_meja', $wm['id_waktu']) ?> value="<?= $wm['id_waktu']; ?>"><?= $wm['waktu'] . " (" . date('H:i', $wm['jam_mulai'] - 25200) . " - " . date('H:i', $wm['jam_selesai'] - 25200) . ")"; ?></option>
                                    <?php endforeach ?>
                                </select>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9 mt-2">
                            <input value="<?= set_value('meja_4', $tmeja['meja_4']); ?>" name="meja_4" id="meja_4" type="text" class="form-control" placeholder="Masukan Jumlah Meja 4 Kursi..." onkeypress="return hanyaAngka(event)">
                    ...
                    <div class="row form-group ">
                        ...
                        <div class="col-md-9 pt-3">
                            <input value="<?= set_value('default_meja4', $tmeja['default_meja4']); ?>" name="default_meja4" id="default_meja4" type="text" class="form-control" placeholder="Masukan Jumlah Meja 4 Kursi..." onkeypress="return hanyaAngka(event)">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?= set_value('harga_meja_4', $tmeja['harga_meja_4']); ?>" name="harga_meja_4" id="harga_meja_4" type="text" class="form-control" placeholder="Masukan Harga Meja 4 Kursi..." onkeypress="return hanyaAngka(event)">
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('meja_2', $tmeja['meja_2']); ?>" name="meja_2" id="meja_2" type="text" class="form-control" placeholder="Masukan Jumlah Meja 2 Kursi..." onkeypress="return hanyaAngka(event)">
                    ...
                    <div class="row form-group ">
                        ...
                        <div class="col-md-9 pt-3">
                            <input value="<?= set_value('default_meja2', $tmeja['default_meja2']); ?>" name="default_meja2" id="default_meja2" type="text" class="form-control" placeholder="Masukan Jumlah Meja 4 Kursi..." onkeypress="return hanyaAngka(event)">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?= set_value('harga_meja_2', $tmeja['harga_meja_2']); ?>" name="harga_meja_2" id="harga_meja_2" type="text" class="form-control" placeholder="Masukan Harga Meja 2 Kursi..." onkeypress="return hanyaAngka(event)">
                            </div>
